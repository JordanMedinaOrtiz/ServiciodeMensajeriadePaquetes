...
/**
 * Clase Logistica extendida de SimpleDrawerBuilder.
 * @author Jordan Medina Ortíz 179913@upslp.edu.mx
 */
public class Logistica extends SimpleDrawerBuilder {
   /**
     ...
     * @param con 
     */
    public Logistica(String email, String nombre, Connection con) {
        this.nombre = nombre;
        this.email = email;
        this.con = con;
    }
